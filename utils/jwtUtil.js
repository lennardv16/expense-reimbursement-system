 ...
 * You cannot forge any of the information inside of the payload or header, because the server will know that it was forged
 */

jwt.verify = Promise.promisify(jwt.verify); // Turn jwt.verify into a function that returns a promise

// verify
const verifyTokenAndReturnPayload = async (token) => {
